...
#else
                Debug.Log($"Extentions | Field with type {typeof(T)} was not set before playing. It's being assigned automatically.");
#endif
...
#else
                Debug.Log($"Extentions | No component of type: {typeof(T)} was found on {comp}.");
#endif
        }
...
#else
                Debug.Log($"Extentions | No component of type: {typeof(T)} was found on {component}.");
#endif
            return component;
        }
